...
train_data <- read.csv("C:/Users/bamini/Documents/Coursera/Practical_Machine_Learning/Course Project/pml-training.csv", na.strings = c("NA","#DIV/0!"))
#classes <- unname(sapply(train_data[,1:59], class))
test_data <- read.csv("C:/Users/bamini/Documents/Coursera/Practical_Machine_Learning/Course Project/pml-testing.csv", na.strings = c("NA","#DIV/0!"))
library(caret)
